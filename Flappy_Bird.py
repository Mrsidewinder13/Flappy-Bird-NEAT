...
pygame.transform.scale2x(pygame.image.load(os.path.join("imgs","bird3.png")))]         #birds images
PIPE_IMG = pygame.transform.scale2x(pygame.image.load(os.path.join("imgs","pipe.png")))    #pipe image
BG_IMG = pygame.transform.scale2x(pygame.image.load(os.path.join("imgs","bg.png")))      #background image
BASE_IMG = pygame.transform.scale2x(pygame.image.load(os.path.join("imgs","base.png")))   #base image
...
def draw_window(win, birds, pipes, base, score, gen):
    ...
    win.blit(text, (WIN_HEIGHT - 10 - text.get_width(), 10))
